...
var laatsNO = exports.laatsNO = (0, _ramda.curry)(function (fs, o) {
    return _op(laats, passN([_op(o, _ramda.always)].concat(_toConsumableArray(fs))));
});
