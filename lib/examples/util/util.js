...
var ifType = exports.ifType = _op3(_index.isType, _index.ifPredicate);

var errString = exports.errString = (0, _index.prop)('message');
var errFull = exports.errFull = ifType('Error')((0, _index.prop)('stack'), _index.id);

var resolveP = exports.resolveP = function resolveP() {
    return Promise.resolve.apply(Promise, arguments);
};
var rejectP = exports.rejectP = function rejectP() {
    return Promise.reject.apply(Promise, arguments);
};
var allP = exports.allP = function allP() {
    return Promise.all.apply(Promise, arguments);
};
var startP = exports.startP = function startP() {
    return _op(null, resolveP);
};