...
var addList = exports.addList = function addList(orig) {
    return function (f) {
        return function (ary) {
            var g = function g() {
...
var mapXL = _op(_op(map, addIndex), addList);
var mapLX = _op(_op(map, addList), addIndex);
...
var _withFilter = function _withFilter(_) {
    return new Map().set(mapAsKeys, mapAsKeysWithFilter).set(mapAsKeysIn, mapAsKeysInWithFilter).set(mapAsValues, mapAsValuesWithFilter).set(mapAsValuesIn, mapAsValuesInWithFilter);
};
