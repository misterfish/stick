...
var transform = (0, _kleisli.k)(_op2(step1, (0, _kleisli.k)(step2)));_op(_op(_op(-1, (0, _index.rangeTo)(3)), (0, _index.map)(_op2(_op2(_bilby.some, transform), getOrElse('none')))), log);