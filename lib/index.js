...
var mergeWithM = exports.mergeWithM = _recurry(3)(_manual2.default.mergeWithM);
...
var getType = exports.getType = function getType(x) {
    return oPro.toString.call(x).slice(8, -1);
};
