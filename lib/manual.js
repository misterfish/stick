...
exports.factoryInit = exports.factoryProps = exports.ifXReplaceStrFlags = exports.ifXReplaceStr = exports.ifXReplace = exports.xReplaceStrFlags = exports.xReplaceStr = exports.xReplace = exports.xMatchStrFlags = exports.xMatchStr = exports.xMatch = exports.xMatchGlobal = exports.match = exports.neuN = exports.neu5 = exports.neu4 = exports.neu3 = exports.neu2 = exports.neu1 = exports.rangeToBy = exports.rangeFromByDesc = exports.rangeFromByAsc = exports.rangeFromBy = exports.ifReplace = exports.timesSide = exports.timesF = exports.timesV = exports.repeatSide = exports.repeatF = exports.repeatV = exports.sprintfN = exports.sprintf1 = exports.flip5 = exports.flip4 = exports.flip3 = exports.flip = exports.prop = exports.split = exports.join = exports.passToN = exports.passTo = exports.applyToN = exports.applyTo5 = exports.applyTo4 = exports.applyTo3 = exports.applyTo2 = exports.applyTo1 = exports.provideToN = exports.provideTo5 = exports.provideTo4 = exports.provideTo3 = exports.provideTo2 = exports.provideTo1 = exports.provideTo = exports.callOnN = exports.callOn5 = exports.callOn4 = exports.callOn3 = exports.callOn2 = exports.callOn1 = exports.callOn = exports.letS = exports.letNV = exports.asterisk = exports.ampersand = exports.reduceObjIn = exports.reduceObj = exports.addCollection = exports.addIndex = undefined;
exports.eachObjIn = exports.eachObj = exports.reject = exports.filter = exports.each = exports.map = exports.mergeWhen = exports.mergeWith = exports.tap = exports.path = exports.mergeIn = exports.mergeInTo = exports.mergeInM = exports.mergeInToM = exports.merge = exports.mergeTo = exports.mergeM = exports.mergeToM = exports.mergeInSym = exports.mergeInMSym = exports.mergeInToSym = exports.mergeInToMSym = exports.mergeSym = exports.mergeMSym = exports.mergeToSym = exports.mergeToMSym = exports.concatM = exports.concatToM = exports.concat = exports.concatTo = exports.prependToM = exports.prependM = exports.prepend = exports.prependTo = exports.appendM = exports.appendToM = exports.appendTo = exports.append = exports.assocM = exports.assoc = exports.defaultTo = exports.decorateException = exports.tryCatch = exports.toThe = exports.moduloWholePart = exports.modulo = exports.subtractFrom = exports.subtract = exports.divideInto = exports.divideBy = exports.multiply = exports.add = exports.condS = exports.cond = exports.condPredicate = exports.whenBind = exports.ifBind = exports.bindTry = exports.bindTryTo = exports.bindTryProp = exports.bindTryPropTo = exports.isType = exports.bind = exports.bindTo = exports.bindProp = exports.bindPropTo = exports.bindLateProp = exports.bindLatePropTo = exports.whenHasIn = exports.ifHasIn = exports.whenHas = exports.ifHas = exports.hasIn = exports.has = exports.whenPredicateOk = exports.ifPredicateOk = exports.whenPredicate = exports.ifPredicate = exports.sideN = exports.side5 = exports.side4 = exports.side3 = exports.side2 = exports.side1 = exports.side = exports.dotN = exports.dot5 = exports.dot4 = exports.dot3 = exports.dot2 = exports.dot1 = exports.dot = exports.lte = exports.lt = exports.gte = exports.gt = exports.ne = exports.eq = exports.recurry = exports.roll = undefined;
...
var mergeFunctions = (_mergeFunctions = {}, _defineProperty(_mergeFunctions, mergeToMSym, mergeToM), _defineProperty(_mergeFunctions, mergeToSym, mergeTo), _defineProperty(_mergeFunctions, mergeMSym, mergeM), _defineProperty(_mergeFunctions, mergeSym, merge), _defineProperty(_mergeFunctions, mergeInToMSym, mergeInToM), _defineProperty(_mergeFunctions, mergeInToSym, mergeInTo), _defineProperty(_mergeFunctions, mergeInMSym, mergeInM), _defineProperty(_mergeFunctions, mergeInSym, mergeIn), _mergeFunctions);
...
var mergeXWith = function mergeXWith(collision) {
    return function (own) {
        return function (src) {
            return function (tgt) {
                var _ref6 = own ? [whenHas, ifHas] : [whenHasIn, ifHasIn],
...
var getInfo = function getInfo(merger) {
    return path(['$$stick', 'merge'])(merger) || (0, _index.die)('Unrecognised merge function');
};

var oldGetInfo1 = function oldGetInfo1(merger) {
    return merger === mergeToM ? [true, true, true] : merger === _index2.default.mergeToM ? [true, true, true] : merger === mergeM ? [false, true, true] : merger === _index2.default.mergeM ? [false, true, true] : merger === mergeTo ? [true, false, true] : merger === _index2.default.mergeTo ? [true, false, true] : merger === merge ? [false, false, true] : merger === _index2.default.merge ? [false, false, true] : merger === mergeInToM ? [true, true, false] : merger === _index2.default.mergeInToM ? [true, true, false] : merger === mergeInM ? [false, true, false] : merger === _index2.default.mergeInM ? [false, true, false] : merger === mergeInTo ? [true, false, false] : merger === _index2.default.mergeInTo ? [true, false, false] : merger === mergeIn ? [false, false, false] : merger === _index2.default.mergeIn ? [false, false, false] : (0, _index.die)('Unrecognised merge function');
};

var mergeWith = exports.mergeWith = function mergeWith(collision) {
    return function (merger) {
        var decorated = function decorated(a) {
            return function (b) {
                var _getInfo = getInfo(merger),
                    to = _getInfo.to,
                    mut = _getInfo.mut,
                    own = _getInfo.own;

                var _ref8 = to ? [b, a] : [a, b],
...
var mergeWhen = exports.mergeWhen = function mergeWhen(p) {
    return function (merger) {
        var decorated = function decorated(a) {
            return function (b) {
                var _getInfo2 = getInfo(merger),
                    to = _getInfo2.to,
                    mut = _getInfo2.mut,
                    own = _getInfo2.own;

                var _ref10 = to ? [b, a] : [a, b],
...
var letS = exports.letS = function letS(specAry) {
    return function (tgt) {
        return _index.laat.apply(undefined, [function (_) {
            return tgt;
...
var timesSide = exports.timesSide = function timesSide(n) {
    return function (f) {
        return repeatSide(f)(n);
    };
};
...
var ifXReplace = exports.ifXReplace = function ifXReplace(yes) {
    return function (no) {
        return function (re) {
            return function (repl) {
                return function (target) {
...
var ifXReplaceStr = exports.ifXReplaceStr = function ifXReplaceStr(yes) {
    return function (no) {
...
var ifXReplaceStrFlags = exports.ifXReplaceStrFlags = function ifXReplaceStrFlags(yes) {
    return function (no) {
        return function (reStr) {
            return function (flags) {
                return function (repl) {
...
var mergeMixinPreM = function mergeMixinPreM(mixin) {
    return function (proto) {
        var chooseTgtWhenOk = function chooseTgtWhenOk(src, tgt) {
            return (0, _index.ok)(tgt) ? tgt : src;
        };
        var mergeToChooseTgtWhenOkM = mergeWith(chooseTgtWhenOk)(mergeToM);
...
//     mixin is nil.
var mergeMixinPostM = function mergeMixinPostM(mixin) {
    return function (proto) {
        var srcOk = function srcOk(src, _) {
            return (0, _index.ok)(src);
        };
        var mergeToWhenSrcOkM = mergeWhen(srcOk)(mergeToM);
