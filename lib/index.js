...
//
var oCreateExtendWith = (0, _ramda.curry)(function (extend, proto) {
    return _op(_op(proto, Object.create), mergeFromM(extend));
});
var oCreateBase = (0, _ramda.curry)(function (proto, extend) {
    return oCreateExtendWith(extend, proto);
});
...
var Cat = function () {
    ...
    return _op(_op(proto, oCreateBase(Animal.proto)), factory);
    // --- or
    // return Animal.proto | oCreateExtendWith (proto) | factory
    // --- or
    // return proto | factoryMixinPre (Animal.proto)
    return _op(proto, factoryMixins([Animal.proto], []));
}();
