...
exports.DogSimpleMixinNotComposey = exports.DogSimpleMixinComposey = exports.DogInitComposey = exports.DogInit = exports.DogSimple = exports.multi = exports.mergeMixins = undefined;
...
var mergeMixins = exports.mergeMixins = function mergeMixins(mixinsPre, proto, mixinsPost) {
    ...
    _op(post, (0, _stick.mergeToM)(proto));
...
var _factoryWithMixins = function _factoryWithMixins(proto) {
    ...
    return {
        ...
        create: function create() {
            ...
            return _op(_op(protoMixed, Object.create), (0, _stick.mergeFromM)(_op(instanceExtension, _ramda.mergeAll)));
        }
    };
};
