...
var applyScalar = exports.applyScalar = (0, _ramda.curry)(function (fs, xs) {
    return _op(_op(xs, (0, _ramda.zip)(fs)), map(function (_ref7) {
...
var applyScalarIfOk = exports.applyScalarIfOk = (0, _ramda.curry)(function (fs, xs) {
    return _op(_op(xs, (0, _ramda.zip)(fs)), map(function (_ref9) {
...
var listDat2 = function listDat2(n) {
    return _op(map(applyTo1(n)), flipC);
};
var listDat3 = flipC(function (n) {
    return map(applyTo1(n));
});
// --- >> is higher.
var listDat4 = _op(_op(_op3(applyTo1, map), _ramda.curry), flipC);
var listDat6 = _op(_op3(applyTo1, map), flipC);

var listDat5 = flipC(function (n) {
    return _op(_op(n, applyTo1), map);
});
...
var mapX = _op(map, addIndex);
var mapXL = _op(_op(map, addIndex), addCollection);
var mapLX = _op(_op(map, addCollection), addIndex);
...
};_op(_op(_op([1, 2, 3], mapX(function (x, idx) {
    _op([_op(x, double), idx], (0, _ramda.tap)(logWith('mapX')));
    return x;
})), mapXL(function (x, idx, ary) {
    _op([_op(x, double), idx, ary], (0, _ramda.tap)(logWith('mapXL')));
    return x;
})), mapLX(function (x, ary, idx) {
    _op([_op(x, double), idx, ary], (0, _ramda.tap)(logWith('mapLX')));
    return x;
}));

var reduceObj = function reduceObj(f) {
    return function (acc) {
        return function (o) {
            var curAcc = acc;
            for (var k in o) {
...
_op(_op(o, mapAsKeysIn(_ramda.identity)), log);

_op(_op(o, valuesIn), log);

_op(_op(o, mapValues(double)), log);

_op(_op(o, mapTuplesIn(function (_ref11) {
...
_op(_op(o, _op(mapAsKeys, withFilter(ok))(mapper)), (0, _ramda.tap)(logWith('ere')));

var reducer = function reducer(acc, _ref13) {
    var _ref14 = _slicedToArray(_ref13, 2),
        k = _ref14[0],
        v = _ref14[1];

    if (k === 'd') return acc;
    return [].concat(_toConsumableArray(acc), [toUpperCase(k)]);
};

_op(_op(o, reduceObj(reducer)([])), log);

_op(o, eachObj(function () {
    for (var _len12 = arguments.length, args = Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {
        args[_key12] = arguments[_key12];
    }

    return _op(args, logWith('eachObj'));
}));
_op(o, _op(eachObj, addIndex)(function () {
...
_op(o, _op(eachObj, addCollection)(function () {
