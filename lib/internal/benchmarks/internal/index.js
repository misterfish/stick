...
var arg4Rest = function arg4Rest() {
    return arguments.length <= 3 ? undefined : arguments[3];
};
var arg4Manual = function arg4Manual(_1, _2, _3, x) {
    return x;
};

var testComposeArg4Rest = function testComposeArg4Rest() {
    arg4Rest(1, 2, 3, 4, 5, 6, 7);
};

var testComposeArg4Manual = function testComposeArg4Manual() {
...
var suiteArg = [function (_) {
    return (0, _util.bench)('arg4, rest', n * 3)(testComposeArg4Rest);
}, function (_) {
    return (0, _util.bench)('arg4, manual', n * 4)(testComposeArg4Manual);
}];
