var ref$, assoc, assocPath, head, tail, reduceRight, chain, identity, reduce, map, filter, join, split, rProp, rPath, rDefaultTo, curry, each, complement, isNil, rRepeat, rTimes, reverse, tap, flip, zip, arrayLs, test, xtest, expectToEqual, expectToBe, array, repeat, times, compact, compactOk, joinOk;
...
ref$ = require('../lib/index'), array = ref$.array, repeat = ref$.repeat, times = ref$.times, compact = ref$.compact, compactOk = ref$.compactOk, joinOk = ref$.joinOk;
