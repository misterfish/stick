...
// @ todo
var xCond = exports.xCond = function xCond() {
    return _op(null, cond.apply(undefined, arguments));
};
...
// @todo
var laatsNO = exports.laatsNO = (0, _ramda.curry)(function (fs, o) {
    return _op(laats, applyToN([_op(o, _ramda.always)].concat(_toConsumableArray(fs))));
});

var laatsO = exports.laatsO = laatsNO;
...
var xMatchGlobal = exports.xMatchGlobal = (0, _ramda.curry)(function (re, mapper, target) {
    ...
    while (m = reGlobal.exec(target)) {
        _op(mapper.apply(undefined, _toConsumableArray(m)), appendToMut(out));
    }return out;
});
    ...
    return laats(function (_) {
        ...
        return {
            ...
            create: function create() {
                ...
                return _op(_op(protoMixed, Object.create), mergeFromMut(_op(instanceExtension, _ramda.mergeAll)));
            }
        };
    });
};
...
// @test
var laatNO = exports.laatNO = (0, _ramda.curry)(function (fs, f, x) {
...
var laatO = exports.laatO = laatNO;
