...
// @test
var mergeWhenOkM = exports.mergeWhenOkM = _recurry(2)(_manual2.default.mergeWhenOkM);
...
var a = [1, 2, 3];
var rejectX = _op(reject, addIndex);
var rejectXC = _op(_op(reject, addIndex), addCollection);
