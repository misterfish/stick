var ref$, assoc, assocPath, head, tail, reduceRight, chain, identity, reduce, map, filter, join, split, rProp, rPath, rDefaultTo, curry, each, complement, isNil, rRepeat, rTimes, reverse, tap, flip, zip, list, test, xtest, expectToEqual, expectToBe, tryCatch, tryCatch__, exception, raise, die, decorateException;
...
ref$ = require('../index'), tryCatch = ref$.tryCatch, tryCatch__ = ref$.tryCatch__, exception = ref$.exception, raise = ref$.raise, die = ref$.die, decorateException = ref$.decorateException;
