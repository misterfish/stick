...
var oStr = Object.prototype.toString;
...
var not = exports.not = function not(f) {
    return !f;
};
...
mergeToM.$$stick = _manual2.default.mergeToM.$$stick = { merge: { to: true, mut: true, own: true } };
mergeM.$$stick = _manual2.default.mergeM.$$stick = { merge: { to: false, mut: true, own: true } };
mergeTo.$$stick = _manual2.default.mergeTo.$$stick = { merge: { to: true, mut: false, own: true } };
merge.$$stick = _manual2.default.merge.$$stick = { merge: { to: false, mut: false, own: true } };
mergeToInM.$$stick = _manual2.default.mergeToInM.$$stick = { merge: { to: true, mut: true, own: false } };
mergeInM.$$stick = _manual2.default.mergeInM.$$stick = { merge: { to: false, mut: true, own: false } };
mergeToIn.$$stick = _manual2.default.mergeToIn.$$stick = { merge: { to: true, mut: false, own: false } };
mergeIn.$$stick = _manual2.default.mergeIn.$$stick = { merge: { to: false, mut: false, own: false }

    // @todo: make 'when' decoratable, like 'with'.
    //
    // --- 'when' forms run the predicate on both the src and tgt, testing for truthiness.
};var mergeToWhenM = exports.mergeToWhenM = _recurry(3)(_manual2.default.mergeToWhenM);
var mergeWhenM = exports.mergeWhenM = _recurry(3)(_manual2.default.mergeWhenM);
var mergeToWhen = exports.mergeToWhen = _recurry(3)(_manual2.default.mergeToWhen);
...
// --- trivial form.
var let1 = exports.let1 = function let1(f) {
    return invoke(f);
};

// --- these can be called directly by speed freaks; `lets` should be good enough for nearly all
// uses.
var let2 = exports.let2 = function let2(f1, f2) {
    var n1 = f1();
    return f2(n1);
};

var let3 = exports.let3 = function let3(f1, f2, f3) {
    var n1 = f1();
    var n2 = f2(n1);
    return f3(n1, n2);
};

var let4 = exports.let4 = function let4(f1, f2, f3, f4) {
    var n1 = f1();
    var n2 = f2(n1);
    var n3 = f3(n1, n2);
    return f4(n1, n2, n3);
...
var let5 = exports.let5 = function let5(f1, f2, f3, f4, f5) {
    var n1 = f1();
    var n2 = f2(n1);
    var n3 = f3(n1, n2);
    var n4 = f4(n1, n2, n3);
...
var let6 = exports.let6 = function let6(f1, f2, f3, f4, f5, f6) {
    var n1 = f1();
    var n2 = f2(n1);
    var n3 = f3(n1, n2);
    var n4 = f4(n1, n2, n3);
...
var letN = exports.letN = function letN(xs) {
    return laat.apply(undefined, _toConsumableArray(xs));
};
...
var laat = exports.laat = function laat() {
    if (arguments.length === 1) return let1.apply(undefined, arguments);
    if (arguments.length === 2) return let2.apply(undefined, arguments);
    if (arguments.length === 3) return let3.apply(undefined, arguments);
    if (arguments.length === 4) return let4.apply(undefined, arguments);
    if (arguments.length === 5) return let5.apply(undefined, arguments);
    if (arguments.length === 6) return let6.apply(undefined, arguments);
...
var mergeMixins = function mergeMixins(mixinsPre, proto, mixinsPost) {
    var reduceMixins = reduce(function (a, b) {
    ...
    return laat(function (_) {
        ...
        return {
            ...
            create: function create() {
                for (var _len6 = arguments.length, instanceExtension = Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
                    instanceExtension[_key6] = arguments[_key6];
                }

                return _op(_op(protoMixed, Object.create), mergeM(_op(instanceExtension, rMergeAll)));
            }
        };
    });
};
...
var factoryMixins = exports.factoryMixins = noop(function (mixinsPre, mixinsPost, proto) {
...
// proto gets altered.
// order difficult.
var factoryMixinPre = exports.factoryMixinPre = noop(function (mixin, proto) {
    return factoryMixinPre([mixin], [], proto);
});
var factoryMixinPost = exports.factoryMixinPost = noop(function (mixin, proto) {
    return factoryMixinPre([], [mixin], proto);
});
...
exports.default = {
    ...
    mergeToInM: mergeToInM, mergeInM: mergeInM,
    mergeToIn: mergeToIn, mergeIn: mergeIn
};