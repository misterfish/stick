...
var ifBind = exports.ifBind = function ifBind(trier) {
    return ifPredicateOk(function (_ref5) {
...
// --- @test
var mergeWhenOkM = exports.mergeWhenOkM = function mergeWhenOkM(src) {
    return function (tgt) {
...
exports.default = {
    ...
    mergeToWhenOkM: mergeToWhenOkM, mergeWhenOkM: mergeWhenOkM,
