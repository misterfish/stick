...
// @todo test
var ifBind = exports.ifBind = (0, _ramda.curry)(function (yes, no, _ref) {
...
var mapPairs = exports.mapPairs = (0, _ramda.curry)(function (f, obj) {
    return _op(obj, ifArray(_op3(_op3((0, _ramda.splitEvery)(2), (0, _ramda.map)(function (_ref5) {
        var _ref6 = _slicedToArray(_ref5, 2),
            k = _ref6[0],
            v = _ref6[1];

        return f(k, v);
    })), _ramda.fromPairs), _op3(_op3(_ramda.toPairs, (0, _ramda.map)(function (_ref7) {
...
var mapPairsIn = exports.mapPairsIn = (0, _ramda.curry)(function (f, obj) {
    return _op(_op(_op(obj, _ramda.toPairsIn), (0, _ramda.map)(function (_ref9) {
...
var applyScalar = exports.applyScalar = (0, _ramda.curry)(function (fs, xs) {
    return _op(_op(xs, (0, _ramda.zip)(fs)), (0, _ramda.map)(function (_ref11) {
...
var applyScalarIfOk = exports.applyScalarIfOk = (0, _ramda.curry)(function (fs, xs) {
    return _op(_op(xs, (0, _ramda.zip)(fs)), (0, _ramda.map)(function (_ref13) {
