...
var ifOk = exports.ifOk = _op(ok, ifPredicate);
var whenOk = exports.whenOk = _op(ok, whenPredicate);

var ifNotOk = exports.ifNotOk = _op(notOk, ifPredicate);
var whenNotOk = exports.whenNotOk = _op(notOk, whenPredicate);

var ifTrue = exports.ifTrue = _op(_op(true, eq), ifPredicate);
var whenTrue = exports.whenTrue = _op(_op(true, eq), whenPredicate);

var ifFalse = exports.ifFalse = _op(_op(false, eq), ifPredicate);
var whenFalse = exports.whenFalse = _op(_op(false, eq), whenPredicate);

var ifYes = exports.ifYes = _op(Boolean, ifPredicate);
var whenYes = exports.whenYes = _op(Boolean, whenPredicate);
var ifNo = exports.ifNo = _op(_op3(Boolean, _ramda.not), ifPredicate);
var whenNo = exports.whenNo = _op(_op3(Boolean, _ramda.not), whenPredicate);
...
var mapPairs = exports.mapPairs = (0, _ramda.curry)(function (f, obj) {
    return _op(obj, ifArray(_op3(_op3((0, _ramda.splitEvery)(2), (0, _ramda.map)(function (_ref9) {
        var _ref10 = _slicedToArray(_ref9, 2),
            k = _ref10[0],
            v = _ref10[1];

        return f(k, v);
    })), _ramda.fromPairs), _op3(_op3(_ramda.toPairs, (0, _ramda.map)(function (_ref11) {
...
// --- >> is higher.
var listDat4 = _op(_op(_op3(applyTo1, _ramda.map), _ramda.curry), flipC);
var listDat6 = _op(_op3(applyTo1, _ramda.map), flipC);
