...
var makeMutable = function makeMutable(merger) {
    return merger === merge ? mergeM : merger === mergeTo ? mergeToM : merger === merge;
};
...
var getInfo = function getInfo(merger) {
    return merger === mergeToM ? ['to', true, true] : merger === _index2.default.mergeToM ? ['to', true, true] : merger === mergeM ? ['from', true, true] : merger === _index2.default.mergeM ? ['from', true, true] : merger === mergeTo ? ['to', false, true] : merger === _index2.default.mergeTo ? ['to', false, true] : merger === merge ? ['from', false, true] : merger === _index2.default.merge ? ['from', false, true] : (0, _index.die)('Unrecognised merge function');
};
