...
var uniqueWith = function uniqueWith(f) {
    return function (xs) {
        var ret = [];
        var s = new Set();
...
var processPodcasts = function processPodcasts(podcasts) {
    ...
    })), uniqueWith((0, _index.prop)(1))), (0, _index.map)(function (_ref8) {
...
var go = function go(url) {
    return _op(_op(_op(_op(_op(_op(_op(_op(url, getPage), (0, _index.tap)(_utilIo.hideCursor)), (0, _index.tap)(function (_) {
        return (0, _utilIo.startSpinner)('getting metadata');
    })), (0, _util.then)((0, _index.tap)(_utilIo.stopSpinner))), (0, _util.then)(_op3(_op3(processPage, (0, _utilBilby.fold)(function (l) {
        // xxx
        console.log('bad', l);
        throw new Error('wuowowowow');
    }, _index.id)), doDownloads))), (0, _util.then)(report())), (0, _util.recover)(_op3((0, _index.prop)('stack'), _utilIo.warn))), (0, _util.then)(_utilIo.showCursor));
};
