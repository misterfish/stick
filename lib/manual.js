...
var assocPathM = exports.assocPathM = function assocPathM(xs) {
    return function (x) {
        return function (o) {
            ...
            var _xs$reduce = xs.reduce(function (_ref6, x) {
...
// --- throw on failure.
var getMergeFunction = getMergeX(function (_ref8) {
    var f = _ref8.f;
    return f;
});
var getMergeInfo = getMergeX(function (_ref9) {
    var to = _ref9.to,
        mut = _ref9.mut,
        own = _ref9.own;
...
var merges = function merges(_) {
    ...
    return _ref10 = {}, _defineProperty(_ref10, _index.mergeToMSym, {
        f: mergeToM,
        to: true,
        mut: true,
        own: true
    }), _defineProperty(_ref10, _index.mergeToSym, {
        f: mergeTo,
        to: true,
        mut: false,
        own: true
    }), _defineProperty(_ref10, _index.mergeMSym, {
        f: mergeM,
        to: false,
        mut: true,
        own: true
    }), _defineProperty(_ref10, _index.mergeSym, {
        f: merge,
        to: false,
        mut: false,
        own: true
    }), _defineProperty(_ref10, _index.mergeInToMSym, {
        f: mergeInToM,
        to: true,
        mut: true,
        own: false
    }), _defineProperty(_ref10, _index.mergeInToSym, {
        f: mergeInTo,
        to: true,
        mut: false,
        own: false
    }), _defineProperty(_ref10, _index.mergeInMSym, {
        f: mergeInM,
        to: false,
        mut: true,
        own: false
    }), _defineProperty(_ref10, _index.mergeInSym, {
        f: mergeIn,
        to: false,
        mut: false,
        own: false
...
var mergeXWith = function mergeXWith(collision) {
    return function (own) {
        return function (src) {
            return function (tgt) {
                var _ref11 = own ? [whenHas, ifHas] : [whenHasIn, ifHasIn],
...
var anyN = exports.anyN = function anyN(fs) {
    return function (x) {
        ...
        try {
            for (var _iterator6 = fs[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                var f = _step6.value;
                if (f(x)) return true;
            }
        } catch (err) {
...
var allPredicate = exports.allPredicate = function allPredicate(p) {
    return function (xs) {
        ...
        try {
            for (var _iterator7 = xs[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                var x = _step7.value;
                if (!p(x)) return false;
            }
        } catch (err) {
...
// --- wrap short-circuiting && / ||
var and = exports.and = function and(x) {
    return function (y) {
        return x && y;
    };
};
var andNot = exports.andNot = function andNot(x) {
    return function (y) {
        return y && !x;
    };
};
var or = exports.or = function or(x) {
    return function (y) {
        return x || y;
    };
};
...
exports.default = {
    ...
    both: both, either: either, allN: allN, anyN: anyN,
