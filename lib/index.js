...
var isFalse = exports.isFalse = _op(false, eq);
...
var ifTrue = exports.ifTrue = _op(isTrue, ifPredicate);
var whenTrue = exports.whenTrue = _op(isTrue, whenPredicate);

var ifFalse = exports.ifFalse = _op(isFalse, ifPredicate);
var whenFalse = exports.whenFalse = _op(isFalse, whenPredicate);

var ifYes = exports.ifYes = _op(isYes, ifPredicate);
var whenYes = exports.whenYes = _op(isYes, whenPredicate);
var ifNo = exports.ifNo = _op(isNo, ifPredicate);
var whenNo = exports.whenNo = _op(isNo, whenPredicate);
...
var whenFunction = _op(isFunction, whenPredicate);
