...
var oldGetInfo1 = function oldGetInfo1(merger) {
    return merger === mergeToM ? [true, true, true] : merger === _index2.default.mergeToM ? [true, true, true] : merger === mergeM ? [false, true, true] : merger === _index2.default.mergeM ? [false, true, true] : merger === mergeTo ? [true, false, true] : merger === _index2.default.mergeTo ? [true, false, true] : merger === merge ? [false, false, true] : merger === _index2.default.merge ? [false, false, true] : merger === mergeToInM ? [true, true, false] : merger === _index2.default.mergeToInM ? [true, true, false] : merger === mergeInM ? [false, true, false] : merger === _index2.default.mergeInM ? [false, true, false] : merger === mergeToIn ? [true, false, false] : merger === _index2.default.mergeToIn ? [true, false, false] : merger === mergeIn ? [false, false, false] : merger === _index2.default.mergeIn ? [false, false, false] : (0, _index.die)('Unrecognised merge function');
};
