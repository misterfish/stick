...
var asterisk = exports.asterisk = (0, _ramda.curry)(function (fs, xs) {
    return xs | zip(fs) | map(function (_ref7) {
...
var _laat = exports._laat = function _laat() {
