...
var xRegExpStr = exports.xRegExpStr = function xRegExpStr(reStr) {
    ...
    return letNV([_op(reStr, removeSpaces), flags], nieuw2(RegExp));
};
    ...
    return laat(function (_) {
        ...
        return {
            ...
            create: function create() {
                ...
                return _op(_op(protoMixed, Object.create), mergeFromM(_op(instanceExtension, rMergeAll)));
            }
        };
    });
};
