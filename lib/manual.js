...
var getInfo = function getInfo(merger) {
    return merger === mergeToM ? ['to', true, true] : merger === _index2.default.mergeToM ? ['to', true, true] : merger === mergeM ? ['from', true, true] : merger === _index2.default.mergeM ? ['from', true, true] : (0, _index.die)('Unrecognised merge function');
};
