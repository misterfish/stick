...
// --- throw on failure.
var getMergeFunction = getMergeX(function (_ref6) {
    var f = _ref6.f;
    return f;
});
var getMergeInfo = getMergeX(function (_ref7) {
    var to = _ref7.to,
        mut = _ref7.mut,
        own = _ref7.own;
...
var merges = function merges(_) {
    ...
    return _ref8 = {}, _defineProperty(_ref8, _index.mergeToMSym, {
        f: mergeToM,
        to: true,
        mut: true,
        own: true
    }), _defineProperty(_ref8, _index.mergeToSym, {
        f: mergeTo,
        to: true,
        mut: false,
        own: true
    }), _defineProperty(_ref8, _index.mergeMSym, {
        f: mergeM,
        to: false,
        mut: true,
        own: true
    }), _defineProperty(_ref8, _index.mergeSym, {
        f: merge,
        to: false,
        mut: false,
        own: true
    }), _defineProperty(_ref8, _index.mergeInToMSym, {
        f: mergeInToM,
        to: true,
        mut: true,
        own: false
    }), _defineProperty(_ref8, _index.mergeInToSym, {
        f: mergeInTo,
        to: true,
        mut: false,
        own: false
    }), _defineProperty(_ref8, _index.mergeInMSym, {
        f: mergeInM,
        to: false,
        mut: true,
        own: false
    }), _defineProperty(_ref8, _index.mergeInSym, {
        f: mergeIn,
        to: false,
        mut: false,
        own: false
...
var mergeXWith = function mergeXWith(collision) {
    return function (own) {
        return function (src) {
            return function (tgt) {
                var _ref9 = own ? [whenHas, ifHas] : [whenHasIn, ifHasIn],
