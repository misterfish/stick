...
var doit = _op3(k(step1), k(step2));_op(_op(_op(_op(-5, (0, _index.rangeTo)(5)), (0, _index.map)(_bilby.some)), (0, _index.map)(_op3(doit, getOrElse('none')))), _fishLib.log);