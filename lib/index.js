...
var OLDflipC = exports.OLDflipC = function () {
    var ifEmpty = ifPredicate(_op3(prop('length'), eq(0)));
    ...
    return function (f) {
        return (0, _ramda.curryN)(2)(function (a, b) {
            ...
            function (_) {
                ...
                return _op(rest, ifEmpty(function (_) {
