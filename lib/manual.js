...
var mergeWithM = exports.mergeWithM = function mergeWithM(collision) {
    return function (src) {
        return function (tgt) {
...
exports.default = {
    ...
    mergeToWithM: mergeToWithM, mergeWithM: mergeWithM,
