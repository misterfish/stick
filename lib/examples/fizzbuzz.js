...
var whenIsMultiple3or7 = _op(isMultiple3or7, _index.whenPredicate);
...
var makeRow = function makeRow(str) {
    return function (n) {
        return _op([n, str], (0, _index.sprintfN)('%s: %s'));
    };
};
...
var fizzBuzz2 = (0, _index.letS)([isMultiple3, isMultiple5, function (_, is3, is5) {
    return _op([is3, is5], andN);
}, function (n, is3, is5, is15) {
    return (0, _index.cond)(_op(_op(is15, _index.blush), (0, _index.guard)(function (_) {
        return _op(n, fizzbuzz);
    })), _op(_op(is3, _index.blush), (0, _index.guard)(function (_) {
        return _op(n, fizz);
    })), _op(_op(is5, _index.blush), (0, _index.guard)(function (_) {
        return _op(n, buzz);
...
_op(_op(1, (0, _index.rangeTo)(100)), (0, _index.map)(fizzBuzz));