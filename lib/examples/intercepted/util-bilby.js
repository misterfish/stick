...
exports.foldRight = exports.cata = exports.sequenceM = exports.toJust = exports.isJust = exports.toEither = exports.flatMap = exports.fold = exports.isLeft = exports.Nothing = exports.Just = exports.Right = exports.Left = undefined;
...
var foldRight = exports.foldRight = function foldRight(decorate) {
    return fold(function (l) {
        return _op(_op(l, (0, _index.concatTo)(decorate + ' ')), _index.die);
    }, _index.id);
};