...
describe('cond', function(){
  describe('condo', function(){
    describe('raw', function(){
      ...
      return test('null test', function(){
        var gotNull;
        gotNull = [false];
        expectToEqual('ok')(
        condo([
