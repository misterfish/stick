...
mergeInToM.$$stick = _manual2.default.mergeInToM.$$stick = { merge: { to: true, mut: true, own: false } };
mergeInM.$$stick = _manual2.default.mergeInM.$$stick = { merge: { to: false, mut: true, own: false } };
mergeInTo.$$stick = _manual2.default.mergeInTo.$$stick = { merge: { to: true, mut: false, own: false } };
